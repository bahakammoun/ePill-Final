...
INSERT INTO user_ (id, idcountry, idgender, idlanguage, size, weight) VALUES (1,1,1,1,168,56);
...
INSERT INTO pharmaceutical_form (id, name) VALUES (3,'Kapseln');
INSERT INTO pharmaceutical_form (id, name) VALUES (4,'Gel');
INSERT INTO pharmaceutical_form (id, name) VALUES (5,'Infusionslösung');
...
INSERT INTO drug_active_substance (iddrug, idactive_substance) VALUES (10,1);
...
INSERT INTO drug_pharmaceutical_form (iddrug, idpharmaceutical_form) VALUES (10,4);
INSERT INTO drug_pharmaceutical_form (iddrug, idpharmaceutical_form) VALUES (6,5);
...
INSERT INTO disease_groups (id, disease_group) VALUES
                    (1,  'Allgemeine Erkrankungen und Beschwerden am Verabreichungsort'),
					(2,  'Erkrankungen der Immunsystems'),
					(3,  'Herzerkrankungen'),
					(4,  'Gefäßerkrankungen'),
					(5,  'Erkrankungen des Gastrointestinaltrakts (Verdauungssystems)'),
					(6,  'Erkrankungen des Blutes und des Lymphsystems'),
					(7,  'Psychiatrische Erkrankungen/ Erkrankungen des Nervensystems'),
					(8,  'Erkrankungen der Haut und des Unterhautzellgewebes'),
					(9,  'Erkrankungen der Nieren und Harnwege'),
					(10,  'Erkrankungen der Geschlechtsorgane und der Brustdrüse'),
					(11,  'Augenerkrankungen'),
					(12,  'Erkrankungen des Ohrs und des Labyrinths'),
					(13,  'Skelettmuskulatur-, Bindegewebs- und Knochenerkrankungen'),
					(14,  'Erkrankungen der Atemwege, des Brustraums und Mediastinums'),
					(15,  'Leber- und Gallenerkrankungen'),
					(16,  'Untersuchungen'),
					(17,  'Stoffwechsel- und Ernährungsstörungen'),
(21,  'Erkrankungen des Ohrs und des Labyrinths (Gleichgewichtssystem)');

INSERT INTO side_effects (id,iddrug,iddisease_groups,very_common,common,uncommon,rare,very_rare,not_known) VALUES
(1,1,1,NULL,'Häufig: Schmerzen im Brustkorb, Erschöpfung, Schwächegefühl','Gelegentlich: Fieber, Wasseransammlungen im Gewebe',NULL,NULL ,NULL ),
(2,1,2,NULL,NULL,NULL,NULL ,NULL,'nicht bekannt: Überempfindlichkeitsreaktionen' ),
(3,1,3,NULL,NULL,'Gelegentlich: Angina pectoris, Herzklopfen, erhöhte Herzschlagfolge, Wasseransammlungen im Gewebe, Herzinfarkt',NULL,'Sehr selten: Herzrhythmusstörungen, Schlaganfall',NULL  ),
(4,1,4,NULL,NULL,NULL,NULL,NULL,'Nicht bekannt: Schwindel beim Aufstehen vom Sitzen oder Liegen'  ),
(5,1,5,NULL,'Häufig: Übelkeit, Erbrechen, Durchfall, (Ober-)Bauchschmerzen, Sodbrennen, Entzündung des Rachenraums, Verdauungsstörungen','Gelegentlich: Mundtrockenheit, trockener Hals, Blähungen, Bauchspeicheldrüsenentzündung (in einigen Fällen mit tödlichem Ausgang), Verstopfung, Appetitlosigkeit','Selten: Geschmacksveränderungen, entzündliche Veränderung der Zungenschleimhaut','Sehr selten: Darmverschluss, Schwellungen im Darmkanal' ,NULL  ),
(6,1,6,NULL,NULL,'Gelegentlich: Veränderung der Blutplättchenzahl',NULL,NULL ,'Nicht bekannt: krankhafte Verringerung oder Veränderung der Blutzellenzahl (Neutropenie, hämolytische Anämie, Thrombozytopenie), vollständiger Verlust bestimmter Blutzellen (Agranulozytose)'  ),
(7,1,7,NULL,'Häufig: Kopfschmerzen, Benommenheit, Erschöpfung, Schlaflosigkeit, Taubheits- und Kältegefühl an den Gliedmaßen, Müdigkeit, Schwindel','Gelegentlich: Depressionen, Nervosität, Schläfrigkeit, Schlafstörungen, Kribbeln, Gleichgewichtsstörungen, Verwirrtheit, vorübergehender Geschmacksverlust','Selten: Bewusstseinsverlust',NULL ,NULL  ),
(8,1,8,NULL,'Häufig: allergische Hautreaktionen wie Hautausschlag','Gelegentlich: Haarausfall, vermehrte Schweißbildung, Blasensucht, Juckreiz, Hautausschlag, Wasseransammlungen in den Lippen, Gesicht und/ oder den Extremitäten (sehr selten mit Beteiligung von Kehlkopf, Rachen und/ oder Zunge), Nesselsucht, Lichtempfindlichkeit','Selten: schwerwiegende Hautreaktionen (Erythema multiforme)','Sehr selten: schwerwiegende Hautreaktionen (wie psoriasiforme Hautveränderungen), Gesichtsrötung, Schwitzen, Nagelablösung, Zunahme der Gefäßkrämpfe bei Raynaud-Krankheit' ,'Nicht bekannt: schwerwiegende Hautreaktionen (Stevens-Johnson-Syndrom, exfoliative Dermatitis, epidermale Nekrolyse)'  ),
(9,1,9,NULL,'Häufig: Nierenfunktionsstörungen','Gelegentlich: Harnwegsinfektionen, vermehrte Eiweißausscheidung im Urin (teilweise mit gleichzeitiger Verschlechterung der Nierenfunktion)',NULL,'Sehr selten: akutes Nierenversagen' ,NULL  ),
(10,1,10,NULL,NULL,'Gelegentlich: Impotenz','Selten: erektile Dysfunktion',NULL ,NULL  ),
(11,1,11,NULL,NULL,'Gelegentlich: Schwachsichtigkeit',NULL,'Sehr selten: verschwommenes Sehen' ,NULL  ),
(12,1,12,NULL,NULL,'Gelegentlich: Ohrgeräusche (Tinnitus), Schwindel',NULL,NULL ,NULL  ),
(13,1,13,NULL,'Häufig: Rückenschmerzen, Muskelschmerzen',NULL,NULL,NULL ,NULL  ),
(14,1,14,NULL,'Häufig: Husten, trockener Reizhusten, Atemnot, Schnupfen','Gelegentlich: Nasennebenhöhlenentzündung, obere Atemwegsinfektionen, Entzündung der Bronchien, Lungenentzündung','Selten: Durst',NULL ,'Nicht bekannt: krampfartige Verengung der Bronchien mit daraus folgender Atemnot'  ),
(15,1,15,NULL,NULL,'Gelegentlich: Leberentzündung',NULL,'Sehr selten: Gelbsucht durch Gallestau oder Leberfunktionsstörungen' ,NULL ),
(16,1,16,NULL,'Häufig: bestimmte Blutbildveränderungen (Abfall von Hämoglobinkonzentration, Hämatokrit, Leukozytenzahl, Thrombozytenzahl sowie, insbesondere bei Patienten mit Nierenfunktionsstörungen, Anstieg der Serumkonzentrationen von Harnstoff oder Kreatinin [bei Begleittherapie mit Diuretika häufiger als unter Monotherapie mit Quinapril, häufig reversibel bei fortgesetzter Therapie], Kalium, Abfall der Natriumkonzentration im Serum)','Gelegentlich: bestimmte Blutbildveränderungen (Insbesondere bei Patienten mit eingeschränkter Nierenfunktion, Kollagenkrankheiten [Kollagenosen] oder gleichzeitiger Therapie mit Allopurinol, Procainamid oder bestimmten Arzneimitteln, die die Abwehrreaktionen unterdrücken, kann es zu Anämie, Eosinophilie, selten sogar zu Panzytopenie kommen.)',NULL,'Sehr selten: bestimmte Blutbildveränderungen (Hämolyse, Erhöhung der Bilirubin- und Leberenzymkonzentrationen)' ,'Nicht bekannt: bestimmte Blutbildveränderungen (hämolytische Anämie im Zusammenhang mit G-6-PDH-Mangel)'  ),
(17,1,17,NULL,'Häufig: erhöhte Kaliumkonzentrationen im Blut',NULL,NULL,NULL ,NULL  ),
(18,2,6,NULL,NULL,NULL,'Selten: Blutbildveränderungen in Form einer Verminderung der roten Blutkörperchen (aplastische Anämie), Verminderung der Blutplättchen (Thrombozytopenie) und Leukozyten im Blut (Leukopenie), hochgradige Verminderung bestimmter weißer Blutkörperchen mit Infektneigung und schweren Allgemeinsymptomen (Agranulozytose)',NULL ,NULL ),
(19,2,2,NULL,NULL,NULL,'Selten: allergische Hauterscheinungen, Überempfindlichkeit (Idiosynkrasie)','Sehr selten: allergischer Schnupfen' ,NULL ),
(20,2,17,NULL,'Häufig: Eine unerkannte Zuckerkrankheit (latenter Diabetes mellitus) kann erkennbar werden oder eine bereits bestehende Zuckerkrankheit sich verschlechtern (Symptome: erhöhter Zuckergehalt des Blutes [Hyperglykämie] oder im Urin [Glykosurie]). Unter der Therapie kann es zu Störungen im Fettstoffwechsel kommen: Bei meist normalem Gesamtcholesterin wurde eine Verminderung des HDL-Cholesterins und eine Erhöhung der Triglyzeride im Plasma beobachtet.Die Harnsäurewerte im Blut können sich erhöhen (Hyperurikämie), bei disponierten Patienten können Gichtanfälle ausgelöst werden. Die Anwendung von Beloc-Zok comp kann bei langfristiger, kontinuierlicher Einnahme zu Veränderungen im Mineralstoffwechsel (Elektrolytveränderungen) führen, insbesondere zu einer Erniedrigung der Blutspiegel von Kalium (Hypokaliämie), Magnesium (Hypomagnesiämie), Natrium (Hyponatriämie) und Chlorid (Hypochlorämie) sowie zu einem erhöhten Calciumspiegel (Hyperkalzämie). Als Folge der Elektrolyt- und Flüssigkeitsverluste kann sich ein Überschuss an Alkali im Blut (metabolische Alkalose) entwickeln bzw. eine bereits bestehende metabolische Alkalose verschlechtern.',NULL,'Selten: Nach längerem strengen Fasten oder schwerer körperlicher Belastung kann es bei gleichzeitiger Therapie mit Beloc-Zok comp zu Zuständen mit erniedrigtem Blutzucker (hypoglykämische Zustände) kommen. Warnzeichen eines erniedrigten Blutzuckers – insbesondere erhöhte Herzfrequenz (Tachykardie) und Zittern der Finger (Tremor) – können verschleiert werden.',NULL ,NULL ),
(21,2,7,'Sehr häufig: Erschöpfung','Häufig: Benommenheit, Kopfschmerzen','Gelegentlich: depressive Verstimmungszustände, Verwirrtheit, Halluzinationen','Selten: Nervosität, Ängstlichkeit,Muskelschwäche, Impotenz, Libido- und Potenzstörungen','Sehr selten: Persönlichkeitsveränderungen (z. B. Gefühlsschwankungen),Erinnerungslücken (Amnesie), Gedächtnisstörungen' ,NULL ),
(22,2,11,NULL,NULL,NULL,'Selten: Entzündung der Bindehaut des Auges (Konjunktivitis) und verminderter Tränenfluss (dies ist beim Tragen von Kontaktlinsen zu beachten), Augenreizung, geringgradige Sehstörungen (z. B. verschwommenes Sehen, Farbsehstörungen [Gelbsehen]) oder eine Verschlimmerung einer bestehenden Kurzsichtigkeit','Sehr selten: Flimmern vor den Augen' ,'nicht bekannt: plötzlich auftretende Kurzsichtigkeit (akute Myopie), akutes Engwinkelglaukom'  ),
(23,2,21,NULL,NULL,NULL,NULL,'Sehr selten: Hörstörungen, Ohrensausen' ,NULL  ),
(24,2,3,NULL,'Häufig: Herzklopfen (Palpitationen), verlangsamter Herzschlag (Bradykardie), Blutdruckabfall beim Aufsetzen (orthostatische Hypotonie, sehr selten mit Bewusstlosigkeit)','Gelegentlich: Verstärkung einer Herzmuskelschwäche mit peripheren Ödemen (Flüssigkeitsansammlungen), bei einem akuten Herzinfarkt kann der Blutdruck stark erniedrigt sein (kardiogener Schock), Herzschmerzen','Selten: Störungen der Erregungsleitung am Herzen (atrioventrikuläre Überleitungsstörungen), unregelmäßige Herzschlagfolge (Arrhythmien)','Sehr selten: Verstärkung der Anfälle bei Angina pectoris' ,NULL  ),
(25,2,4,NULL,'Häufig: Kältegefühl in den Gliedmaßen',NULL,'Selten: Gefäßentzündung (Vaskulitis)','Sehr selten: Verstärkung (bis zum Absterben des Gewebes) bereits bestehender peripherer Durchblutungsstörungen' ,NULL  ),
(26,2,14,NULL,'Häufig: Atemnot bei Belastung (Belastungsdyspnoe)','Gelegentlich: Infolge einer möglichen Erhöhung des Atemwiderstands kann es bei Patienten mit Neigung zu Verkrampfungen der Atemwege (bronchospastischen Reaktionen, z. B. bei asthmoider Bronchitis) insbesondere bei obstruktiven Atemwegserkrankungen zu einer Verengung der Atemwege und zu Atemnot kommen.','Selten: Lungenentzündung (akute interstitielle Pneumonie)','Sehr selten: Flüssigkeitsansammlung in der Lunge (allergisches Lungenödem) mit Schocksymptomatik' ,NULL  ),
(27,2,5,NULL,'Häufig: Vorübergehend Magen-Darm-Beschwerden wie Übelkeit, Leibschmerzen, Durchfall, Verstopfung','Gelegentlich: Erbrechen, Appetitlosigkeit, Krämpfe','Selten: Mundtrockenheit, Entzündung der Bauchspeicheldrüse',NULL ,NULL  ),
(28,2,15,NULL,NULL,NULL,'Selten: Erhöhung der Leberwerte (Transaminasen GOT, GPT), Gelbsucht, Gallestau (intrahepatische Cholestase); akute Gallenblasenentzündung (bei bestehendem Gallensteinleiden)','Sehr selten: Leberentzündung (Hepatitis)' ,NULL  ),
(29,2,8,NULL,NULL,'Gelegentlich: Hautreaktionen wie Rötung und Juckreiz sowie Hautausschläge (meist psoriasiforme und dystrophische Hautläsionen), Schwitzen, stark juckende Quaddeln (Urtikaria), Lichtempfindlichkeit mit Auftreten von Hautausschlägen nach Lichteinwirkung.','Selten: kleinflächige Einblutungen in der Haut und Schleimhaut (Purpura), Haarausfall, Blutgefäßentzündung (nekrotisierende Angiitis)','Sehr selten: Arzneimittel, die Betarezeptorenblocker enthalten, können in Einzelfällen eine Schuppenflechte (Psoriasis vulgaris) auslösen, die Symptome dieser Erkrankung verschlechtern oder zu Schuppenflechte-ähnlichen (psoriasiformen) Hautausschlägen führen; Schmetterlingsflechte (kutaner Lupus erythematodes)' ,'Nicht bekannt: chronisch-entzündliche Bindegewebserkrankung (systemischer Lupus erythematodes)'  ),
(30,2,13,NULL,NULL,NULL,NULL,'Sehr selten: Bei Langzeittherapie wurde in Einzelfällen eine Erkrankung der Gelenke (Arthropathie) und/ oder Arthralgie (Gelenkschmerzen) beobachtet, wobei ein oder mehrere Gelenke betroffen sein können (Mono- und Polyarthritis).' ,NULL  ),
(31,2,9,NULL,NULL,NULL,'Selten: akute Nierenentzündung (interstitielle Nephritis)',NULL ,NULL ),
(32,2,1,NULL,NULL,'Gelegentlich: Gewichtszunahme','Selten: Arzneimittelfieber. Bei hoher Dosierung kann es, insbesondere bei Vorliegen von Venenerkrankungen, zum Verschluss von Blutgefäßen durch Blutgerinnsel (Thrombosen und Embolien) kommen.','Sehr selten: Geschmacksstörungen' ,NULL  ),
(33,2,16,NULL,NULL,'Gelegentlich: reversibler Anstieg stickstoffhaltiger, harnpflichtiger Stoffe (Harnstoff, Kreatinin) im Blut, vor allem zu Behandlungsbeginn.','Selten: Erhöhung der Blutfettwerte',NULL ,NULL  );